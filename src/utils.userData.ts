...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    description:
      "O CNAB Reader tem como objetivo a leitura, interpretação, formatação de informações de arquivo CNAB. O Back-end da aplicação armazena as informações em um banco de dados relacional usando o SGBD PostgreSQL.",
